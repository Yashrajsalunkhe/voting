...
export async function registerRoutes(app) {
    ...
    app.post("/api/votes", async (req, res) => {
        try {
            ...
            auditLogger.log(AuditLogger.ACTIONS.DATABASE_ERROR, { error: error instanceof Error ? error.message : 'Unknown error', endpoint: '/api/votes' }, undefined, undefined, req.ip, req.get('User-Agent'));
